...
Route::post('song/{song}/addsong',[SongController::class, 'addPlaylist'])->name('song.addPlaylist');
Route::post('song/{song}/removesong',[SongController::class, 'removePlaylist'])->name('song.removePlaylist');
